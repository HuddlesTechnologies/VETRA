/* =========================================================
   ...
   vendor/assets/ui.js's VendorUI, so every app shows the same
   in-app confirmation style instead of the browser's own "this
   page says" dialog. Reuses the same .modal-overlay/.modal-panel
   markup customer/orders.html's report-an-issue modal already
   established, so no new CSS is needed.
   ========================================================= */
...
const CustomerUI = (() => {
  ...
  // ---- Photo preview modal (profile photo save-or-cancel) ----
